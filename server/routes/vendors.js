...
router.put('/:id', auth, async (req, res) => {
  try {
    const allowedFields = ['name', 'phone', 'price', 'pricingType', 'maxCapacity', 'description', 'photos', 'serviceId', 'location', 'contacts', 'specialPricing', 'dateForwardPricing', 'fridaySurcharge', 'saturdaySurcharge'];
    const updates = {};
